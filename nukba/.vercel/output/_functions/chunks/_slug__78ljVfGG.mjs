...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (!product) return Astro2.redirect("/en");
  const lang = "en";
  ...
  return renderTemplate`${renderComponent($$result, "PublicLayout", $$PublicLayout, { "lang": lang, "title": product.nameEn, "description": product.descEn.slice(0, 160), "canonical": `${baseUrl}/en/products/${slug}`, "alternateUrl": `${baseUrl}/products/${slug}`, "ogImage": product.images[0], "ogType": "product", "product": product, "settings": settings, "categories": categories, "breadcrumbs": [
...
}, "D:/Furniture/nukba/src/pages/en/products/[slug].astro", void 0);
const $$file = "D:/Furniture/nukba/src/pages/en/products/[slug].astro";
const $$url = "/en/products/[slug]";
